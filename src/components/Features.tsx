...
const Features = () => {
  ...
  return (
    <section id="features" className="py-20 bg-naukri-beige">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className="group bg-naukri-beige p-6 rounded-xl border border-gray-100 hover:border-naukri-green/20 hover:shadow-lg transition-all duration-500 animate-fade-in hover:scale-105 hover:-translate-y-2"
