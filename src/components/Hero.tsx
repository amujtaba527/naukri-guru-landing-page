        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8 animate-fade-in" style={{animationDelay: '0.4s'}}>
              ...
              <Button size="lg" variant="outline" className="border-naukri-green text-naukri-green hover:bg-naukri-green hover:text-white px-8 py-4 text-lg group transition-all duration-300 hover:scale-105 hover:shadow-lg">
