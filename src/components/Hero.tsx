...
const Hero = () => {
  return (
    <section className="py-20 lg:py-28 bg-naukri-beige">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6 animate-fade-in">
              AI-Powered Hiring & 
              <span className="text-naukri-green animate-fade-in" style={{ animationDelay: '0.2s' }}> Interview Preparation</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 leading-relaxed animate-fade-in" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8 animate-fade-in" style={{ animationDelay: '0.4s' }}>
              <Button 
                size="lg" 
                className="bg-naukri-amber hover:bg-naukri-amber/90 text-black font-semibold px-8 py-4 text-lg group transition-all duration-300 hover:scale-105 hover:shadow-xl"
              >
                Try for Free
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="border-naukri-green text-naukri-green hover:bg-naukri-green hover:text-white px-8 py-4 text-lg group transition-all duration-300 hover:scale-105 hover:shadow-lg"
              >
                <Play className="mr-2 h-5 w-5 group-hover:scale-110 transition-transform duration-300" />
                Request a Demo
              </Button>
            </div>
            <div className="flex items-center gap-8 text-sm text-gray-500 animate-fade-in" style={{ animationDelay: '0.5s' }}>
            ...
            <div className="bg-gradient-to-br from-naukri-green to-naukri-green/80 rounded-2xl p-8 text-white shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105">
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="bg-white/10 rounded-lg p-4 animate-fade-in hover:bg-white/20 transition-colors duration-300" style={{ animationDelay: '0.7s' }}>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-white/10 rounded-lg p-3 text-center animate-fade-in hover:bg-white/20 transition-all duration-300 hover:scale-105" style={{ animationDelay: '0.8s' }}>
                      <div className="text-2xl font-bold text-naukri-amber">94%</div>
                      <div className="text-xs">Confidence Score</div>
                    </div>
                    <div className="bg-white/10 rounded-lg p-3 text-center animate-fade-in hover:bg-white/20 transition-all duration-300 hover:scale-105" style={{ animationDelay: '0.9s' }}>
