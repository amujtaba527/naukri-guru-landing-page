          ...
          <div className="inline-flex items-center bg-naukri-beige rounded-full px-6 py-3 shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 hover:scale-105">
            <div className="flex items-center gap-4">
              <div className="flex -space-x-2">
                {['AG', 'KL', 'DM', 'RS'].map((initials, i) => <div key={i} className="w-8 h-8 bg-naukri-green rounded-full flex items-center justify-center border-2 border-white hover:scale-110 transition-transform duration-300" style={{
                animationDelay: `${i * 0.1}s`
              }}>
