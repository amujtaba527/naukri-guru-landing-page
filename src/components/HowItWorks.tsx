...
const HowItWorks = () => {
  ...
  return <section id="how-it-works" className="py-20 bg-[#f5f5dc]">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => <div key={index} className="text-center animate-fade-in group" style={{
          animationDelay: `${index * 0.15}s`
              ...
              <div className="relative mb-6">
                ...
                {index < steps.length - 1 && <div className="hidden lg:block absolute top-8 left-full w-full h-0.5 bg-gradient-to-r from-naukri-green to-naukri-amber/50 animate-fade-in" style={{
