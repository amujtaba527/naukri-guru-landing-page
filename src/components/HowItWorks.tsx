            ...
            <div key={index} className="text-center animate-fade-in group" style={{ animationDelay: `${index * 0.15}s` }}>
              <div className="relative mb-6">
                ...
                {index < steps.length - 1 && (
                  <div className="hidden lg:block absolute top-8 left-full w-full h-0.5 bg-gradient-to-r from-naukri-green to-naukri-amber/50 animate-fade-in" style={{ animationDelay: `${(index + 1) * 0.2}s` }}></div>
                )}
              </div>
